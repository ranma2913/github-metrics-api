...
import com.optum.riptide.devops.githubmetricsapi.codeQL.ScanRepoClasses.CodeQlAlerts
import com.optum.riptide.devops.githubmetricsapi.codeQL.ScanRepoClasses.Rule
...
//    'riptide-poc'             | 'Needs vitals.yaml' | 'riptide-poc_missing_vitals.xlsx'
    ...
    private Map<String, Integer> getCodeQLIssueCount(GHRepository repo, String orgName) {
        ...
        try {
            responseEntity = sslRestTemplate.exchange(
                    "${githubEnterprise.getApiUrl()}/repos/{owner}/{repo}/code-scanning/alerts",
                    HttpMethod.GET,
                    requestEntity,
                    ArrayList.class,
